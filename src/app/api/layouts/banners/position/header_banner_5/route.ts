...
const FALLBACK_BANNERS = [
    {
        ...
        order: 1,
        buttonText: 'Khám phá cẩm nang',
        buttonUrl: '/cam-nang-du-lich',
    },
];
...
export async function GET(request: NextRequest) {
    ...
    const backendUrl = `${API_CMS_URL}/api/layouts/banners/position/header_banner_5?language=${language}&isActive=${isActive}`;
    try {
